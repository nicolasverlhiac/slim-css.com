<nav id="nav-side" class="nav">
					    <ul>
					        <li class="<?php if($f=='' || $f=='typographie.php' ) echo 'current';?>"><a href="typographie.php">Typographie</a></li>
							<li class="<?php if($f=='' || $f=='grille.php' ) echo 'current';?>"><a href="grille.php">Grille</a></li>
							<li class="<?php if($f=='' || $f=='tableaux.php' ) echo 'current';?>"><a href="tableaux.php">Tableaux</a></li>
